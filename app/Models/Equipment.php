...
class Equipment extends Model {
    ...
    protected static $logAttributes = ['title','status','type','code','department_id', 'date_failure', 'reason' ];
    ...
    public function equipment_transfer(){
        return $this->hasMany('App\Models\Transfer','equipment_id','id');
    }
    ...
    public function maintenances() {
        return $this->hasMany('App\Models\Maintenance', 'equipment_id', 'id');
    }
