                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="equipment_id" class="form-control" value="{{ $transfers->transfer_equipment->title }}" disabled>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <label class="control-label">{{ __('Số lượng') }} <small>  </small></label>
                                    <input type="number" min="0"  value="{{ $transfers->amount }}"  id="amount" name="amount" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="note" value="{{ $transfers->note }}" class="form-control"z>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <div class="row">
