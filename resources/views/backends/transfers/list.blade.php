               ...
               <form class="dev-form" action="" name="listEvent" method="POST">
                  ...
                  <table class="table table-striped table-bordered" role="table">
                     ...
                     <tr>
                        ...
                        <td>  
                           <a class="btn btn-primary btn-sm" title="Word" href="{{ route('transfer.wordExport',$transfer->id ) }}"><i class="far fa-file-word"> Word</i></a>
                           <a class="btn btn-warning btn-sm" title="Pdf" href="{{ route('transfer.showPdf',$transfer->id ) }}"><i class="far fa-file-pdf"> Pdf</i></a>
                           <a class="btn btn-success btn-sm" title="Phê duyệt" href="{{ route('transfer.edit',['id'=>$transfer->id,'supplies_id'=> isset($transfer->transfer_equipment->id) ? $transfer->transfer_equipment->id :'' ] ) }}"><i class="fas fa-share"></i></a>
                           <a title="Xóa" class="btn btn-danger btn-sm" href="{{ route('transfer.delete',$transfer->id ) }}" data-toggle="modal" data-target="#sideModal" data-direct="modal-top-right"><i class="fas fa-trash"></i></a>
                        </td>
                     </tr>
                        @endforeach
                        @else
