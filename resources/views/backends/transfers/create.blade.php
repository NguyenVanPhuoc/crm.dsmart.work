                        ...
                        @include('notices.index')
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <select class="form-control select2" id="equipment_id_transfer"  name="equipment_id">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" min="0" id="amount" name="amount" class="form-control" value="{{ Request::old('amount') }}" >
                                </div>
                            </div>
                     
                            <div class="form-group">
                                <label class="control-label">{{ __('Lựa chọn khoa phòng điều chuyển đến') }} <small></small></label>
                                <select class="form-control select2" id="department_id_transfer" name="department_id">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" class="editor form-control" id="" cols="30" rows="10">Xin điều chuyển thiết bị từ khoa tới khoa</textarea>
