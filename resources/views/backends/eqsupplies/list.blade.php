         ...
         <div class="card">
            <div class="card-body p-0">
               ...
               <form class="dev-form" action="" name="listEvent" method="POST">
                  @csrf
                  <table class="table table-striped projects table_eqsupplies" role="table">
                     <thead class="thead">
                        <tr>
                     ...
                     <tr>
                        ...
                        <td class="group-action text-right action_supplies">
                           <a class="text-success" title="Thiết bị tương thích" href="{{ route('eqsupplie.showCompatible',$eqsupplie->id ) }}"><i class="fas fa-share"></i></a>
                           <a class="text-dark" title="Cập nhật" href="{{ route('eqsupplie.edit' , $eqsupplie->id )}}"><i class="fas fa-edit"></i></a>
                           ...
                           @endcan
                           <a class="btn btn-danger btn-sm" title="Xóa" href="{{ route('eqsupplie.delete',$eqsupplie->id ) }}" data-toggle="modal" data-target="#sideModal" data-direct="modal-top-right"><i class="fas fa-trash"></i></a>
                       </td>                       
                     </tr>
                        @endforeach
                        @else
