                ...
                <form action="{{ route('eqrepair.store',['equip_id'=>$equipments->id]) }}" class="dev-form" method="POST" data-toggle="validator" role="form">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input name="date_failure" type="date" class="form-control"  value="{{ $equipments->date_failure !=null ? $equipments->date_failure : date('Y-m-d')}}" data-error="Vui lòng chọn ngày báo hỏng">
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input name="expected_cost" type="text" class="form-control"  value="{{ Request::old('expected_cost') }}" data-error="Vui lòng nhập chi phí dự kiến">
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label">{{ __('Chi phí thực tế') }}<small> </small></label>
                            <input name="actual_costs" type="text" class="form-control"  value="{{ Request::old('actual_costs') }}" data-error="Vui lòng nhập chi phí thực tế">
                        </div>
