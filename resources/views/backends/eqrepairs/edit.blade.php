                ...
                <form action="{{ route('eqrepair.update',['equip_id'=>$equipment->id,'repair_id'=>$repair->id]) }}" class="dev-form" method="POST" data-toggle="validator" role="form">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input name="date_failure" type="date" class="form-control"  value="{{ $equipment->date_failure }}">
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input name="reason" type="text" class="form-control"  value="{{ $equipment->reason }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label">{{ __('Chi phí dự kiến') }}<small> </small></label>
                            <input name="expected_cost" type="text" class="form-control"  value="{{ convert_currency($repair->expected_cost) }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label">{{ __('Chi phí thực tế') }}<small> </small></label>
                            <input name="actual_costs" type="text" class="form-control"  value="{{ convert_currency($repair->actual_costs) }}">
                        </div>
