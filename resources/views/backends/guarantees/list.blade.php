                  ...
                  <table class="table table-striped table-bordered" role="table">
                     ...
                     <tr>
                        ...
                        <td class="group-action action text-nowrap">
                           <a class="text-dark" href="{{ route('guarantee.edit',$equipment->id) }}" title="{{ __('Lịch sử bảo hành') }}"><i class="fas fa-tools"></i></a>
                           <a class="text-dark ml-1 mr-1 guarantee" data-title="{{ $equipment->title }}" data-href="{{ route('guarantee.post',$equipment->id) }}" title="{{ __('Tạo lịch sử bảo hành') }}"><i class="fas fa-plus-square"></i></a>
                        </td> 
                     </tr>
                        @endforeach
                        @else
