                              ...
                              <tr>
                                 ...
                                 @for($day=1; $day <= $daysInMonth; $day++)
                                    ...
                                    <td class="text-center p-0 align-middle p-relative">
                                       ...
                                       @else
                                          <a href="{{ route('maintenance_act.update',['equip_id' => $equipment->id, 'main_id' => $item->id, 'id'=>$act_obj->id]) }}" user-id="{{getUserById($act_obj->author_id)}}" data-id="{{ $act_obj->id }}" code="{{ $act_obj->code }}" type="{{ $act_obj->type}}" class="btn-action">{!! $act_obj->showType() !!}</a>
                                       @endif
                                    </td>
                                 @endfor
                              </tr>
         ...
         <form action="" name="deleteChoose" method="POST" id="frm-action">
            ...
            <div class="modal-body">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-9">
                     <input type="text" name="note" class="form-control" value="" placeholder="Nhập ghi chú" data-error="{{ __('Vui lòng nhập ghi chú')}}" required>
                  </div>
               </div>
            </div>
            <div class="modal-footer">
