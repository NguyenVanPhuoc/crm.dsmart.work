         ...
         <div class="row search-filter">
            <div class="col-md-2 filter">
               <ul class="nav-filter">
                  ...
                  <li class=""><a class="btn btn-success" style="color: #fff;" href="{{ route('equipment.export') }}"><i class="far fa-file-excel"></i> {{ _('Excel') }}</a></li>
               </ul>
            </div>
                     ...
                     <tr>
                        ...
                        <td class="group-action action">
                              ...
                              @elseif ( $equipment->status == "corrected" )
                                    ...
                                    @endcan    
                              @endif
                              <a class="text-dark" title="Nhập vật tư kèm theo" href="{{ route('equipment.createSupplie',$equipment->id )}}">
                                 <i class="fas fa-plus-square"></i>
                              </a>
                              <a class="text-dark" title="Hồ sơ thiết bị" href="{{ route('equipment.show' , $equipment->id )}}">
                                 <i class="fa fa-eye"></i>
                              </a> 
                              <a class="text-dark" title="Cập nhật thiết bị" href="{{ route('equipment.edit' , $equipment->id )}}">
                                 <i class="fas fa-edit"></i>
                              </a>
                              @if($equipment->status == "liquidated" || $status == "")
                              <a class="btn btn-danger btn-sm" title="Xóa thiết bị" href="{{ route('equipment.delete',$equipment->id ) }}" data-toggle="modal" data-target="#sideModal" data-direct="modal-top-right"><i class="fas fa-trash"></i></a>
                              @endif
                        </td> 
                        <!-- <td>
           ...
           <div class="modal-content">
            ...
            <form id="hand_form"  action="" name="frmProducts" data-filter="{{ route('equiment.selectHandOver') }}" class="form-horizontal" method="POST" novalidate="">
                  ...
                  <div class="form-group">
                     ...
                     <input type="date" name=""  value="{{ $cur_time }}" class="form-control">
                     <div class="help-block with-errors"></div>
                  </div>
           ...
           <div class="modal-content">
            ...
            <form id="inactive_form"  action="" name="frmProducts" class="form-horizontal" method="POST" novalidate="">
                  ...
                  <div class="form-group">
                     ...
                     <input type="date" name=""  value="" class="form-control datetimepicker"  required>
                     <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
...
<div class="modal fade" id="modal_corrected" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
           <div class="modal-content">
             <div class="modal-header">
             <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="myModalLabel">Cập nhật trạng thái thiết bị</h4>
            </div>
            <div class="modal-body">
            <form id="corrected_form"  action="" name="frmProducts" class="form-horizontal" method="POST" novalidate="">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="" placeholder="Lý do hỏng ..."  class="form-control" data-error="{{ __('Vui lòng nhập người chịu trách nhiệm')}}" required>
                     <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                     <label class="control-label">{{ __('Thời gian cập nhật') }} <small></small></label>
                     <input type="date" name="" placeholder="Thời gian cập nhật ..."   class="form-control" data-error="{{ __('Vui lòng nhập thời gian cập nhật')}}" required>
                     <div class="help-block with-errors"></div>
                  </div>
                  <div class="modal-footer">
...
<!-- <div class="modal fade" id="modal_was_broken_device" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
           <div class="modal-content">
             <div class="modal-header">
             <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title" id="myModalLabel">Đăng ký lịch sửa chữa</h4>
            </div>
            <div class="modal-body">
            <form id="was_broken_device_form"  action="" name="frmProducts"  class="form-horizontal" method="POST" novalidate="">
                  @csrf
                  @method('PUT')
                  <div class="form-group">
                  <label class="control-label">{{ __('Thiết bị') }} <small></small></label>
                        <input type="text" name=""  class="form-control" value="{{ Request::old('') }}" data-error="{{ __('Vui lòng nhập lý do hỏng')}}" required>
                        <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                  <label class="control-label">{{ __('Thời gian') }} <small></small></label>
                        <input type="date" name=""  class="form-control" value="{{ Request::old('') }}" required>
                        <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                  <label class="control-label">{{ __('Đơn vị sửa chữa') }} <small></small></label>
                        <input type="text" name=""  class="form-control" value="" required>
                        <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                  <label class="control-label">{{ __('Thông tin liên hệ') }} <small></small></label>
                        <input type="text" name=""  class="form-control" value="" required>
                        <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                  <label class="control-label">{{ __('Người lập lịch') }} <small></small></label>
                        <input type="text" name=""  class="form-control" value="{{ Auth::user()->name }}" disabled required>
                        <div class="help-block with-errors"></div>
                  </div>
                  <div class="modal-footer">
                     <button type="submit" class="btn btn-success" onclick="return confirm('Bạn có chắc chắn bàn giao thiết bị?')" value="add">Lưu</button>
