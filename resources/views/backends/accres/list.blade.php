                  ...
                  <table class="table table-striped table-bordered" role="table">
                     ...
                     <tr>
                        ...
                        <td class="group-action action">
                           <a class="text-dark" href="{{ route('accre.edit',$equipment->id) }}" title="{{ __('Lịch sử kiểm định') }}"><i class="fas fa-tools"></i></a>
                           <a class="text-dark ml-1 mr-1 accre-modal" data-title="{{ $equipment->title }}" data-href="{{ route('accre.post',$equipment->id) }}" title="{{ __('Tạo lịch sử kiểm định') }}"><i class="fas fa-plus-square"></i></a>
                        </td> 
                     </tr>
                        @endforeach
                        @else
           ...
           <div class="modal-content">
            ...
            <form id="accre_show_form"  action="" name="frmProducts"  class="form-horizontal" method="POST" novalidate="">
                  ...
                  <div class="form-group">
                     ...
                     <textarea name="content" id="" class="form-control" required>{{ Request::old('content') }}</textarea>
                     <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                     <label class="control-label">{{ __('Ghi chú') }} <small></small></label>
                     <input type="text" name="note" value="{{ Request::old('note') }}" class="form-control" data-error="{{ __('Vui lòng nhập tiêu đề hiển thị')}}" required>
                     <div class="help-block with-errors"></div>
                  </div>
