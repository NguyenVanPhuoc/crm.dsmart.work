                        ...
                        @if(!$transfers->isEmpty())
                           @foreach($transfers as $key => $transfer)
                              <tr class="text-center">
                                 ...
                                 <td>{{ isset($transfer->transfer_equipment) && $transfer->transfer_equipment->code != null ? $transfer->transfer_equipment->code : '-' }}</td>
                                 <td>{{ isset($transfer->transfer_equipment) ? $transfer->transfer_equipment->title : '-' }}</td>
